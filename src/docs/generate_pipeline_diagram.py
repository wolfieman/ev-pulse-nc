...
def create_pipeline_diagram():
    ...
    # ── Title ──────────────────────────────────────────────────────────────
    draw_text(ax, 5, 15.9, "EV Pulse NC", fontsize=22, color="#1F3864", weight="bold")
    draw_text(
        ax,
        5,
        15.45,
    ...
    draw_text(
        ax, x1_left, y1 - 0.05, "BEV forecasts verified", fontsize=8, color="#B4C7E0"
    )
    draw_text(
        ax,
        x1_left,
    ...
    draw_text(
        ax, x1_right, y1 - 0.05, "NC stations via AFDC API", fontsize=8, color="#B4C7E0"
    )
    draw_text(
        ax,
        x1_right,
    ...
    draw_text(ax, x_gap, y_gap - 0.18, "Demand vs. Supply", fontsize=8, color="#C5DEB5")
    ...
    draw_text(ax, x_lens[0], y_lenses + 0.45, "Phase 3", fontsize=8, color="#D4E4F7")
    draw_text(
        ax,
        x_lens[0],
        y_lenses + 0.15,
    ...
    draw_text(
        ax, x_lens[0], y_lenses - 0.40, "Sub-county gaps", fontsize=7.5, color="#B4C7E0"
    )
    draw_text(ax, x_lens[0], y_lenses - 0.58, "Mar 2026", fontsize=7, color="#A0B8D0")
    draw_status_badge(
    ...
    draw_text(ax, x_lens[1], y_lenses + 0.45, "Phase 4", fontsize=8, color="#E8F0F8")
    draw_text(
        ax,
        x_lens[1],
        y_lenses + 0.15,
    ...
    draw_text(ax, x_lens[1], y_lenses - 0.58, "Mar 2026", fontsize=7, color="#A8C4DC")
    draw_status_badge(
    ...
    draw_text(ax, x_lens[2], y_lenses + 0.45, "Phase 5", fontsize=8, color="#E8F0F8")
    draw_text(
        ax,
        x_lens[2],
        y_lenses + 0.15,
    ...
    draw_text(ax, x_lens[2], y_lenses - 0.58, "Apr 2026", fontsize=7, color="#A8C4DC")
    draw_status_badge(
    ...
    draw_rounded_box(
        ax, 5.0, y_score, score_w, score_h, C_CONVERGE, C_BORDER_CONVERGE, linewidth=2.5
    )
    draw_text(
        ax,
        5.0,
        y_score + 0.45,
        "NEVI Scoring Framework",
        fontsize=13,
        color=C_TEXT_LIGHT,
        weight="bold",
    )
    ...
    draw_rounded_box(
        ax, 5.0, y_out, out_w, out_h, C_OUTPUT, C_BORDER_OUTPUT, linewidth=2.5
    )
    draw_text(
        ax,
        5.0,
    ...
    draw_text(
        ...
        sb_x,
        p6_y + 0.07,
        "Phase 6: Buffer Analysis",
        fontsize=8,
        color=C_TEXT_DARK,
        weight="semibold",
    )
    draw_text(
        ax, sb_x, p6_y - 0.14, "Enhancement to Phase 3", fontsize=6.5, color="#777777"
    )
    ...
    draw_text(
        ...
        sb_x,
        p7_y + 0.07,
        "Phase 7: NCDOT Corridor",
        fontsize=8,
        color=C_TEXT_DARK,
        weight="semibold",
    )
    draw_text(
        ax, sb_x, p7_y - 0.14, "Optional benchmark", fontsize=6.5, color="#777777"
    )
    ...
    # Legend background
    draw_rounded_box(ax, leg_x, leg_y, leg_w, leg_h, "white", "#D0D0D0", linewidth=1.0)
    ...
    for item_y, fc, ec, label in legend_items:
        ...
        ax.add_patch(box)
        draw_text(
            ax, swatch_x + 0.7, item_y, label, fontsize=7.5, color="#555555", ha="left"
        )

    # Optional legend item (dashed border)
    opt_item_y = leg_y - 1.25
    box = FancyBboxPatch(
        (swatch_x, opt_item_y - 0.12),
        0.5,
        0.24,
        boxstyle="round,pad=0.02,rounding_size=0.02",
        facecolor=C_OPTIONAL,
        edgecolor=C_BORDER_OPTIONAL,
        linewidth=1.0,
        linestyle="--",
        zorder=3,
    )
